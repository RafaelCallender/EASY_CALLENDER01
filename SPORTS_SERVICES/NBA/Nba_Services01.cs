using EASY_CALLENDER01.MODEL.SPORT_MODEL.NBA_MODEL.NBA_GET_MODEL;
...
namespace EASY_CALLENDER01.SERVICES.SPORTS_SERVICES.NBA
{
    public class Nba_Services01
    {
        ...
        public async Task<string> GET_Seasons()
        {
            ...
            return await nba_data01($"https://api-nba-v1.p.rapidapi.com/seasons");;
        }
        public async Task<string> GET_Leagues()
        {
    
            return  await nba_data01($"https://api-nba-v1.p.rapidapi.com/leagues");;
        }
        public async Task<string> GET_Games(string input)
        {
            //input = "2022-12-25"  "yyyy-MM-dd"
    
            return await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?date={input}");
        }
        public async Task<string> GET_Games_between_two_teams()
        {
            
            return await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?h2h=1-2");
        }
        public async Task<string> GET_Games_in_live()
        {
        
            return await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?live=all");
        }
        public async Task<string> GET_Games_per_season(string input)
        {
            //input = "2020"
            
            return  await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?season={input}");
        }
        ...
        public async Task<string> GET_Games_per_team_and_season(string input, string input01)
        {
            //input=year
            //input01=team id
            return await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?season={input}&team={input01}");
        }
        public async Task<string> GET_Games_per_id(string input)
        {
            
            return await nba_data02($"https://api-nba-v1.p.rapidapi.com/games?id={input}");
        }
        public async Task<string> GET_Teams()
        {

            
            return await nba_data03($"https://api-nba-v1.p.rapidapi.com/teams");
        }
        public async Task<string> GET_Teams_per_conference(int input)
        {
            //input = Eastern or Western    
            
            return await nba_data04($"https://api-nba-v1.p.rapidapi.com/teams?conference={input}");
        }
        ...
        public async Task<string> GET_Teams_per_division(int input)
        {
            ...
            return await nba_data04($"https://api-nba-v1.p.rapidapi.com/teams?division={input}");
        }
        ...
        public async Task<string> GET_Teams_per_code(int input)
        {
            ...
            return await nba_data04($"https://api-nba-v1.p.rapidapi.com/teams?code={input}");
        }
        public async Task<string> GET_Teams_per_id(int input)
        {
            //input = team id like 14 for Los Angeles Lakers 
        
            return await nba_data04($"https://api-nba-v1.p.rapidapi.com/teams?id{input}");
        }
        ...
        public async Task<string> GET_Standings(int input)
        {
            ...
            return await nba_data05($"https://api-nba-v1.p.rapidapi.com/standings?league=standard&season={input}");
        }
        public async Task<string> GET_Standings_per_conference_and_season(int input, int input1)
        {
            ...
            return await nba_data05($"https://api-nba-v1.p.rapidapi.com/standings?league=standard&season={input}&conference={input1}");
        }
        ...
        public async Task<string> GET_Standings_per_team_and_season(int input,int input1)
        {
            ...
            return await nba_data05($"https://api-nba-v1.p.rapidapi.com/standings?league=standard&season={input}&team={input1}");
        }
        public async Task<string> GET_Games_Statistics()
        {

         
            return await nba_data06($"https://api-nba-v1.p.rapidapi.com/games/statistics?id=10403");
        }
        public async Task<string> GET_Teams_Statistics(int input, int input1)
        {
            ...
            return await nba_data07($"https://api-nba-v1.p.rapidapi.com/teams/statistics?id={input}&season={input1}");
        }
        public async Task<string> GET_Players_Statistics_per_player_and_season(int input)
        {
            //input = "2020"        

            return await nba_data08($"https://api-nba-v1.p.rapidapi.com/players/statistics?id=236&season={input}");
        }
        public async Task<string> GET_Players_Statistics_per_team_and_season(int input, int input1)
        {
            ...
            return await nba_data08($"https://api-nba-v1.p.rapidapi.com/players/statistics?team={input}&season={input1}");
        }
        public async Task<string> GET_Players_Statistics_per_game_id()
        {

   
            return await nba_data08($"https://api-nba-v1.p.rapidapi.com/players/statistics?game=8133");
        }
        public async Task<string> GET_Search_teams()
        {

  
            return await nba_data03($"https://api-nba-v1.p.rapidapi.com/teams?search=atl");
        }
        public async Task<string> GET_Search_players()
        {

   
            return await nba_data09($"https://api-nba-v1.p.rapidapi.com/players?search=james");
        }
