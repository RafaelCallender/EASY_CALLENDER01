using EASY_CALLENDER01.MODEL.AI_MODEL.AI_TEXT_TO_IMAGE.GET_MODEL;
using EASY_CALLENDER01.SERVICES.PYTHON_SERVICES.PYTHON_HELPER;
using EASY_CALLENDER01.SERVICES.FILE_SERVICES.TEXT_FILES;
using Newtonsoft.Json;
using System.Net.Http.Headers;
using System.Text;
namespace EASY_CALLENDER01.SERVICES.AI_SERVICES.AI_TEXT_TO_IMAGE
{
    public class Ai_Text_To_Image01
    {
