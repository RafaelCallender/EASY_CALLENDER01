using EASY_CALLENDER01.MODEL.AI_MODEL.AI_IMAGE_MODEL_EDIT.GET_MODEL;
using EASY_CALLENDER01.MODEL.AI_MODEL.AI_IMAGE_MODEL_EDIT.SET_MODEL;
...
namespace EASY_CALLENDER01.SERVICES.AI_SERVICES.IMAGE_EDIT
{
    public class Image_Edit02
    {
