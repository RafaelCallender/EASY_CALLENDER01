...
namespace EASY_CALLENDER01.AI_SERVICES.AI_TEXT_TO_TEXT
{
    public class Ai_Text_To_Text05
    {
...
### SAVED TEXT
{File_Helper01.file_path_data02[(int)File_Helper01.file_path_data01_enum.all_books].Trim()}
