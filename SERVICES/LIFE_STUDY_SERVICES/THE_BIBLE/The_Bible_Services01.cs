using EASY_CALLENDER01.MODEL.LIFE_STUDY_MODEL.THE_BIBLE_MODEL.THE_BIBLE_GET_MODEL;
using EASY_CALLENDER01.SERVICES.FILE_SERVICES.PDF_FILES;
using EASY_CALLENDER01.SERVICES.FILE_SERVICES.TEXT_FILES;
using System.Text;


namespace EASY_CALLENDER01.SERVICES.LIFE_STUDY_SERVICES.THE_BIBLE
{
    public class The_Bible_Services01
    {
