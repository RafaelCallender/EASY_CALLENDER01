...
namespace EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_MANAGER.SQLITE_CLIENTS_MANAGER
{
    ...
    {
        private static string[] dbPath ={ Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"CLIENT01.db"),
        ...
        static Sqlite_Client_Maanger01()
        {
