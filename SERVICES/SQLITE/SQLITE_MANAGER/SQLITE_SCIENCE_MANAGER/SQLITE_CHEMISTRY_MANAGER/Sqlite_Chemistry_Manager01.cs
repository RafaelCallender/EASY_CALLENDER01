...
namespace EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_MANAGER.SQLITE_SCIENCE_MANAGER.SQLITE_CHEMISTRY_MANAGER
{
    public class Sqlite_Chemistry_Manager01
    {


        private static string[] dbPath_ ={ Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"Chem01.db"),
                                          Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"Chem02.db")
