...
namespace EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_MANAGER.SQl_NEWS_MANAGER
{
    public class Sqlite_News_Manager01
    {
        private static string[] dbPath ={ Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"NEWS01.db"),
                                          Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"NEWS01.db"),
