...
using EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_MANAGER.SQLITE_EMAIL_SERVICES;



namespace EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_EMIAL_SERVICES
{
    public class Sqlite_File_Services01
    {
