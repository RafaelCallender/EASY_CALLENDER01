using EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_MOVIES_SERVICES;
using EASY_CALLENDER01.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_MOIVES_SERVICES;
using System.Threading.Tasks;
namespace EASY_CALLENDER01.SERVICES.MOVIES_SERVICES
{
    public class Movies_Services01
    {
