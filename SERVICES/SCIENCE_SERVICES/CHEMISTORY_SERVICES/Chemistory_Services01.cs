...
namespace EASY_CALLENDER01.SERVICES.SCIENCE_SERVICES.CHEMISTORY_SERVICES
{
    public class Chemistory_Services01
    {
        ...
        public async Task<string> find_element_using_sqlite(string input)
        {
            ...
            if (Security_Serv01.string_only_digit(input,out data01[22]) == true)
            {
