...
private static  Chemistry_Get_Model01 Chemistry_Get_M01=new Chemistry_Get_Model01();    
  ...
  public string[] data_array = {"Alkali Metals",//0
       ...
       public async Task<string> insert_element_using_sqlite()
{
 

    for (int i = 0; i < Chemistry_H01.atomic_number.Count; i++)
    {
     var   result = await Sqlite_Serv02.insert_element(
    ...
    return   Chemistry_Get_M01.SqliteOutString;
}



public async Task<string>insert_category_elements_using_sqlite()
        {
      ...
      { Chemistry_H01.Alkali_Metals.Count,
            ...
            {
        var     result = await Sqlite_Serv01.insert_element_category(Chemistry_H01.Alkaline_Earth_Metals[b], Chemistry_H01.Alkaline_Earth_Metals[b],
