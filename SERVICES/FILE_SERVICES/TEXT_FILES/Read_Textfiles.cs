...
namespace EASY_CALLENDER01.SERVICES.FILE_SERVICES.TEXT_FILES
{
    public class Read_Textfiles
    {
        ...
        private static Stream?[] stream01 = { assembly.GetManifestResourceStream(file_helper[0]),
                                             ...
                                             assembly.GetManifestResourceStream(file_helper[12]),
                                              ...
                                              assembly.GetManifestResourceStream(file_helper[14]),
        ...
        private static string[] folder = { @"C:\Users\calle\OneDrive\Desktop\PROJECTS\GITHUB\EASY_CALLENDER01\FILES\TEXT\TEXT_SAVED" };
        private static string[] folder01 = { "/home/swageteam101/Desktop/OneDrive/PROJECTS/EASY_CALLENDER01/FILES/TEXT/TEXT_SAVED" };
        private static string[] files = Directory.GetFiles(folder01[0], "*.*", SearchOption.AllDirectories);
        ...
        public string[] GMAIL_CREDENTIAL => data01[6].Split("\n");
        public string[] hairstyle_info_01 => data01[7].Split("\n");
        public string[] hairstyle_info_02 => data01[8].Split("\n");
        public string[] Language_Abbreviation => data01[9].Split("\n");
        public string[] Language_Name => data01[10].Split("\n");
        public string[] Sql_info01 => data01[11].Split("\n");
