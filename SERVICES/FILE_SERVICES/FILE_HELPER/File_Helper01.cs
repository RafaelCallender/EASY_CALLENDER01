        ...
        private static readonly string[] VideoExtensions01 =
{
    ...
    ".asf"
        ...
        public static string[] file_path_data01 = {       @"C:\Users\calle\OneDrive\Desktop\PROJECTS\GITHUB\EASY_CALLENDER01\FILES\TEXT\TEXT_SAVED\mytextfile01.txt",
 ...
 private static string[] data14 = Directory.GetFiles(file_path_data01[(int)file_path_data01_enum.find_webb], "*", SearchOption.AllDirectories);
...
webb_question=9			
        ...
        private static string[] txtfiles = Directory.GetFiles(file_path_data01[(int)file_path_data01_enum.find_cs], "*.txt", SearchOption.AllDirectories);
