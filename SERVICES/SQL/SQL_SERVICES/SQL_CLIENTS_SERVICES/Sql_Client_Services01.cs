...
namespace EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_CLIENTS_SERVICES
{
    ...
    (int)Sql_Manager01.Connection_strings.Connection03};
        ...
        public bool insert_client(string input01, string input02, string input03,
                                  ...
                                  string input10, string input11, string input12, string input13,
                                  string input14, 
                                  out string output)
        {
            DateTime dateTime = DateTime.Now;
            string today_date = dateTime.ToString("yyyy-MM-dd HH:mm:ss");
...
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_emailaddress", input02);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_phonenumber", input03);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_api_key", input04);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_cashappdata01", input05);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_zelleappdata01", input06);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_venmoappdata01", input07);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_paypalappdata01", input08);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_logo", input09);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_latitude", Location_Helper01.get_latitude);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_longitude", Location_Helper01.get_longitude);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_primary_color", input10);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_secondary_color", input11);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_tertiary_color", input12);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_social_media", input13);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_type", input14);
Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_date_created",today_date);
