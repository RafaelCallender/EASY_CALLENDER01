...
using EASY_CALLENDER01.SERVICES.SQL_SERVICES.SQL.SQL_MANAGER.SQL_MANAGER_NBA;
...
namespace EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_SPORTS_SERVICES.SQL_NBA_SERVICES
{
    ...
    public class Sql_Nba_Services01
    {
        ...
        public bool view_nba_database_storedprocedures(out string output)
        {
            bool status = true;
            output = string.Empty;
            Sql_Manager02.conn[0].Open();
            Sql_Manager02.cmd[(int)Sql_Manager02.command_strings.view_nba_database_storedprocedures].CommandType = CommandType.Text;
            using (SqlDataReader reader = Sql_Manager02.cmd[(int)Sql_Manager02.command_strings.view_nba_database_storedprocedures].ExecuteReader())
            {
                if (reader.Read())
                {
                    while (reader.Read())
