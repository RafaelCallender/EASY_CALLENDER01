using EASY_CALLENDER01.SERVICES.SQL.SQL_MANAGER.SQL_MOVIES_MANAGER;
using Microsoft.Data.SqlClient;
using System.Data;


namespace EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_MOVIES_SERVICES
{
    public class Sql_Movie_Services01
    {
