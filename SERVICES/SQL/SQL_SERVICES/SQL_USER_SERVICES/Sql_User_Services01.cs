using EASY_CALLENDER01.MODEL.SQL_MODEL.SQL_MODEL.SQL_USER_MODEL.SQL_USER_GET_MODEL;
using EASY_CALLENDER01.SERVICES.LOCATION.LOCATION_HELPER;
using EASY_CALLENDER01.SERVICES.SQL_SERVICES.SQL.SQL_MANAGER.SQL_MANAGER_USER;
using Microsoft.Data.SqlClient;
using System.Data;
using EASY_CALLENDER01.SERVICES.LOCATION.LOCATION_HELPER;
namespace EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_USER_SERVICES
{
    public class Sql_Services01
    {
                                          ...
                                          string input07, out string output)
        {
            ...
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@longitude", Location_Helper01.get_longitude);
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@latitude", Location_Helper01.get_latitude);
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@creation_date", today_date);
            ...
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@text_file_creation_date", today_date);
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@audio_file_creation_date",today_date);
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@image_file_creation_date", today_date);
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.insert_user].Parameters.AddWithValue("@video_file_creation_date", today_date);
        ...
        public bool view_user_database_storedprocedures(out string output)
        {

            output = string.Empty;
            Sql_Manager01.conn[0].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.view_user_database_storedprocedures].CommandType = CommandType.Text;
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.view_user_database_storedprocedures].ExecuteReader())
            {
                if (reader.Read())
                {
                    while (reader.Read())
