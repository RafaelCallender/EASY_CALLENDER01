...
Sql_H01.build_connection_string02(
        ...
        private static SqlCommand[] cmd_ = {   new SqlCommand("find_code_using_code", conn_[index]),                 // 0
                                               ...
                                               new SqlCommand("view_all_data_from_language_table", conn_[index]),
                                              new SqlCommand("SELECT name FROM sys.procedures ORDER BY name", conn_[index]),   // 5
        ...
        public enum command_strings
        {
            ...
            view_languge_database_storedprocedures = 6
        }
    }
}