...
namespace EASY_CALLENDER01.SERVICES.MYSQL.MYSQL_SERVICES.MYSQL_SPORTS_SERVICES.MYSQL_NBA_SERVICES
{
    ...
    public class MySql_Nba_Services07
    {
        ...
        public string find_Season(string input01)
        {
            ...
            MySql_Nba_Manager01.cmd[53].Parameters.Clear();
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@Season", input01);
                                            ...
                                            string input07, string input08)
        {
            ...
            MySql_Nba_Manager01.cmd[53].Parameters.Clear();
            MySql_Nba_Manager01.cmd[53].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@SeasonID", input00);
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@Season", input01);
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@StartYear", input02);
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@EndYear", input03);
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@Description", input04);
            MySql_Nba_Manager01.cmd[54].Parameters.AddWithValue("@RegularSeasonStartDate", input05);
            MySql_Nba_Manager01.cmd[54].Parameters.AddWithValue("@PostSeasonStartDate", input06);
            MySql_Nba_Manager01.cmd[54].Parameters.AddWithValue("@SeasonType01", input07);
            MySql_Nba_Manager01.cmd[53].Parameters.AddWithValue("@ApiSeason", input08);
            object result = MySql_Nba_Manager01.cmd[53].ExecuteScalar();
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[54].CommandType = CommandType.StoredProcedure;
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[54].ExecuteReader())
            {
                while (reader.Read())
                {
                    Season.Add(int.Parse(reader["Season"]?.ToString() ?? ""));
