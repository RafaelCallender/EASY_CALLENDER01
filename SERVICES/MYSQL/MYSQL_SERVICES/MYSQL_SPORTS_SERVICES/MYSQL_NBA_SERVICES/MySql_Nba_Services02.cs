using EASY_CALLENDER01.MODEL.SPORT_MODEL.NBA_MODEL.NBA_SET_MODEL;
...
namespace EASY_CALLENDER01.SERVICES.MYSQL.MYSQL_SERVICES.MYSQL_SPORTS_SERVICES.MYSQL_NBA_SERVICES
{
    ...
    public class MySql_Nba_Services02
    {
                                            ...
                                            string input13, string input14, string input15, string input16, string input17)
        {
            ...
            MySql_Nba_Manager01.cmd[42].Parameters.Clear();
            MySql_Nba_Manager01.cmd[42].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@PlayerID", input01);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@SportsDataID", input02);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Status", input03);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@TeamID", input04);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Team", input05);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Jersey", input06);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@PositionCategory", input07);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Position", input08);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@FirstName", input09);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@LastName", input10);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@BirthDate", input11);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@BirthCity", input12);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@BirthState", input13);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@BirthCountry", input14);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@GlobalTeamID", input15);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Height", input16);
            MySql_Nba_Manager01.cmd[42].Parameters.AddWithValue("@Weight", input17);
            object result = MySql_Nba_Manager01.cmd[42].ExecuteScalar();
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[39].CommandType = CommandType.StoredProcedure;
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[39].ExecuteReader())
            {
                while (reader.Read())
                {
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[40].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[40].Parameters.Clear();
            MySql_Nba_Manager01.cmd[40].Parameters.AddWithValue("@FirstName", input01);
            MySql_Nba_Manager01.cmd[40].Parameters.AddWithValue("@LastName", input02);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[40].ExecuteReader())
            {
                if (reader.Read())
                {
                    PlayerID.Add(int.Parse(reader["PlayerID"]?.ToString() ?? string.Empty));
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[41].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[41].Parameters.Clear();
            MySql_Nba_Manager01.cmd[41].Parameters.AddWithValue("@PlayerID", input01);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[41].ExecuteReader())
            {
                if (reader.Read())
                {
                    PlayerID.Add(int.Parse(reader["PlayerID"]?.ToString() ?? string.Empty));
