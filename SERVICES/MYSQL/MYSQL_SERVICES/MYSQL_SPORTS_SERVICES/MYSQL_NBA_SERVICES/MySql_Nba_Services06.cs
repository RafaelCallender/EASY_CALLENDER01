...
namespace EASY_CALLENDER01.SERVICES.MYSQL.MYSQL_SERVICES.MYSQL_SPORTS_SERVICES.MYSQL_NBA_SERVICES
{
    ...
    public class MySql_Nba_Services06
    {
        ...
        public string find_Stadium_by_Address(string input)
        {
            ...
            MySql_Nba_Manager01.cmd[50].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[50].Parameters.Clear();
            MySql_Nba_Manager01.cmd[50].Parameters.AddWithValue("@Address", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[51].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        public string find_Stadium_by_City(string input)
        {
            ...
            MySql_Nba_Manager01.cmd[50].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[50].Parameters.Clear();
            MySql_Nba_Manager01.cmd[50].Parameters.AddWithValue("@City", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[50].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[49].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[49].Parameters.Clear();
            MySql_Nba_Manager01.cmd[49].Parameters.AddWithValue("@StadiumID", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[49].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[48].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[48].Parameters.Clear();
            MySql_Nba_Manager01.cmd[48].Parameters.AddWithValue("@Name", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[48].ExecuteReader())
            {
                if (reader.Read())
                {
                                            ...
                                            string input07, string input08, string input09, string input10, string input11)
        {
            ...
            input11 = input11 ?? "";
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[46].Parameters.Clear();
            MySql_Nba_Manager01.cmd[46].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@StadiumID", input01);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Active", input02);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Name", input03);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Address", input04);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@City", input05);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@State", input06);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Zip", input07);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Country", input08);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@Capacity", input09);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@GeoLat", input10);
            MySql_Nba_Manager01.cmd[46].Parameters.AddWithValue("@GeoLong", input11);
            object result = MySql_Nba_Manager01.cmd[46].ExecuteScalar();
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[53].CommandType = CommandType.StoredProcedure;
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[53].ExecuteReader())
            {
                while (reader.Read())
                {
                    StadiumID.Add(int.Parse(reader["StadiumID"]?.ToString() ?? string.Empty));
