...
namespace EASY_CALLENDER01.SERVICES.SQL.SQL_SERVICES.SQL_SPORTS_SERVICES.SQL_NBA_SERVICES
{
    public class MySql_Nba_Services03
    {
                                            ...
                                            string input28, string input29)
        {
            ...
            MySql_Nba_Manager01.cmd[35].Parameters.Clear();
            MySql_Nba_Manager01.cmd[35].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Season", input01);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@SeasonType", input02);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@TeamID", input03);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Key", input04);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@City", input05);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Name", input06);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Conference", input07);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Division", input08);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Wins", input09);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Losses", input10);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Percentage", input11);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@ConferenceWins", input12);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@ConferenceLosses", input13);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@DivisionWins", input14);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@DivisionLosses", input15);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@HomeWins", input16);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@HomeLosses", input17);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@AwayWins", input18);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@AwayLosses", input19);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@LastTenWins", input20);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@LastTenLosses", input21);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@PointsPerGameFor", input22);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@PointsPerGameAgainst", input23);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@Streak", input24);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@GamesBack", input25);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@StreakDescription", input26);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@GlobalTeamID", input27);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@ConferenceRank", input28);
            MySql_Nba_Manager01.cmd[35].Parameters.AddWithValue("@DivisionRank", input29);

            object result = MySql_Nba_Manager01.cmd[35].ExecuteScalar();
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[36].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[36].Parameters.Clear();
            MySql_Nba_Manager01.cmd[36].Parameters.AddWithValue("@TeamID", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[36].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        {
            MySql_Nba_Manager01.conn[5].Open();
            MySql_Nba_Manager01.cmd[37].CommandType = CommandType.StoredProcedure;
            MySql_Nba_Manager01.cmd[37].Parameters.Clear();
            MySql_Nba_Manager01.cmd[37].Parameters.AddWithValue("@Name", input);
            using (MySqlDataReader reader = MySql_Nba_Manager01.cmd[37].ExecuteReader())
            {
                if (reader.Read())
                {
                    TeamID.Add(reader["TeamID"]?.ToString() ?? string.Empty);
